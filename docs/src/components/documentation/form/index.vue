<template>
	<div>
		...
		<p>Use the <code class="color-secondary">toggle</code> property <code class="color-secondary">oo-toggle</code> to <markup>input type="checkbox"</markup> preceding <markup>label</markup></p>
		<input oo-toggle id="toggle-1" type="checkbox">
		...
		<input oo-toggle="large" id="toggle-large-1" type="checkbox">
		<label class="text-large" for="toggle-large-1">Toggle large</label>

		<input oo-toggle="large" id="toggle-large-2" type="checkbox">
