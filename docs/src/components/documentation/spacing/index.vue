<template>
	<div>
		...
		<p>Add your own spacing if the list is not enough through the variables <code class="color-info">$v-spacing-addon</code> <code class="color-info">$h-spacing-addon</code></p>
