<template>
	<div>
		...
		<h3 id="vertical"><router-link to="#vertical">#</router-link> Vertical</h3>
		...
		<h3 id="horizontal"><router-link to="#horizontal">#</router-link> Horizontal</h3>
		...
		<h3 id="custom"><router-link to="#custom">#</router-link> Custom</h3>
